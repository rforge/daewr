...
C
			...
			IFA(2)=-1
C			
C NUMBER OF VERTICES EXCEEDS ROW DIMENSION OF MATRIX XVT
C
            STOP
 240     CONTINUE
 250  CONTINUE
...
C
C  INCONSISTENT CONSTRAINT--FATAL ERROR
C
      IFA(1)=-1
      STOP
2000  CONTINUE
...
C
 ...
 350  IF (NCENT .LE. N2) GO TO 360
      IFA(4)=-1
C
C NUMBER OF CENTROIDS EXCEEDS ROW DIMENSION OF MATRIX CENT
C
      STOP
 360  CONTINUE
C 
